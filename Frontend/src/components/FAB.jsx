...
export default function FAB({ onSelectAction }) {
  ...
  const actions = [
    { id: 'latte', label: 'Poppata', icon: Baby, color: 'bg-blue-500 shadow-blue-500/20 text-white hover:bg-blue-600' },
    { id: 'pappa', label: 'Pappa Solida', icon: Utensils, color: 'bg-emerald-500 shadow-emerald-500/20 text-white hover:bg-emerald-600' },
    { id: 'peso', label: 'Pesata', icon: Weight, color: 'bg-amber-500 shadow-amber-500/20 text-white hover:bg-amber-600' },
  ];
